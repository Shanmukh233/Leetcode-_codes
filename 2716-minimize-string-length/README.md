<h2><a href="https://leetcode.com/problems/minimize-string-length/?envType=problem-list-v2&envId=hash-table">2716. Minimize String Length</a></h2><h3>Easy</h3><hr><p>Given a string <code>s</code>, you have two types of operation:</p>
